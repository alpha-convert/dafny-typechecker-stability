...
//     ensures forall i | 0 <= i < |es| :: es[i].0 in res.Keys
//     ensures forall k | k in res.Keys :: KeyExists(k,es) && evalIntrinsic(ctx,mt[k],env,LastOfKey(k,es)) == evalIntrinsicRecordExpr(ctx,mt,env,es)[k]
